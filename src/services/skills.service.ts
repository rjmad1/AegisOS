...
export class SkillsService {
  ...
  private getDefaultSkills(): SkillDefinition[] {
    const domains = [
      ...
      { id: "rag-knowledge", name: "RAG & Knowledge Systems", purpose: "Query semantic data indexes, search vector databases, and format RAG context injected vectors.", triggers: ["rag", "knowledge base", "vector search", "embedding", "semantic retrieval"], tools: ["mcp_obsidian_search", "mcp_raja-knowledge-repository_query"] },
