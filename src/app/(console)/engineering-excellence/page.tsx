// src/app/(console)/engineering-excellence/page.tsx
"use client";
...
import { 
  ...
  Layers, HardDrive, Network, UserCheck, BookOpen, Trash2, ArrowRight
} from "lucide-react";
...
export default function EngineeringExcellencePage() {
  ...
  return (
    <div className="space-y-6 text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/20 pb-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
            <Cpu className="w-8 h-8 text-primary" /> Executive Engineering Cockpit
          </h1>
      ...
      {actionMessage && (
        <Alert variant="warning" className="border-yellow-500/20 bg-yellow-500/5 py-3">
          <AlertTriangle className="h-4 w-4 text-yellow-500" />
          <AlertTitle className="text-xs font-bold text-yellow-600">PKIP Pipeline Log</AlertTitle>
