...
|---|---|---|---|
| **SCM Services Control** | `PlatformServiceManager.ts` | Host service starts/stops via SCM execution | [Operations Guide](file:///C:/Users/rajaj/Projects/AegisOS/docs/Operations_Guide.md) |
| **Watchdog Heartbeat** | `SelfHealingFramework.ts` | Port probes checking active pids in watchdog | [Troubleshooting Guide](file:///C:/Users/rajaj/Projects/AegisOS/docs/Troubleshooting_Guide.md) |
| **GPU Telemetry** | `GpuProvider` | Dynamic nvidia-smi queries in `infrastructure-providers.ts` | [Observability Guide](file:///C:/Users/rajaj/Projects/AegisOS/docs/OBSERVABILITY.md) |
| **Zero-Trust Auth** | `authorization.ts` | Role validation testing in `EnterpriseReadiness.test.ts` | [Security Guide](file:///C:/Users/rajaj/Projects/AegisOS/SECURITY.md) |
| **Backup-Restore RTO** | `BackupRecoveryCoordinator.ts` | Vitest RTO metric tests under 1.5 seconds | [Disaster Recovery Guide](file:///C:/Users/rajaj/Projects/AegisOS/docs/Disaster_Recovery_Guide.md) |
| **Docker Containers** | `ContainerProvider` | Dynamic `docker ps` scanning in `infrastructure-providers.ts` | [Deployment Guide](file:///C:/Users/rajaj/Projects/AegisOS/docs/DEPLOYMENT.md) |
| **WSL distributions** | `InfrastructureDiscoveryEngine.ts` | `wsl -l -v` command verification during discovery | [Administrator Guide](file:///C:/Users/rajaj/Projects/AegisOS/docs/Administrator_Guide.md) |
