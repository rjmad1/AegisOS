...
### 1. [Executive Architecture](file:///C:/Users/rajaj/Projects/AegisOS/docs/mobile/architecture/00_EXECUTIVE_ARCHITECTURE.md)
...
### 2. [Mobile Architecture](file:///C:/Users/rajaj/Projects/AegisOS/docs/mobile/architecture/01_MOBILE_ARCHITECTURE.md)
...
### 3. [Layered Clean Architecture](file:///C:/Users/rajaj/Projects/AegisOS/docs/mobile/architecture/02_LAYERED_ARCHITECTURE.md)
...
### 4. [Feature Modules Hierarchy](file:///C:/Users/rajaj/Projects/AegisOS/docs/mobile/archive/03_FEATURE_MODULES.md)
...
### 5. [Backend API Gateway Architecture](file:///C:/Users/rajaj/Projects/AegisOS/docs/mobile/architecture/04_BACKEND_API_ARCHITECTURE.md)
...
### 6. [Synchronization Strategy](file:///C:/Users/rajaj/Projects/AegisOS/docs/mobile/architecture/05_SYNCHRONIZATION.md)
...
### 7. [Local Database Design](file:///C:/Users/rajaj/Projects/AegisOS/docs/mobile/architecture/06_LOCAL_DATABASE.md)
...
### 8. [Security & Cryptography Architecture](file:///C:/Users/rajaj/Projects/AegisOS/docs/mobile/architecture/07_SECURITY_ARCHITECTURE.md)
...
### 9. [Communication & Design System Foundation](file:///C:/Users/rajaj/Projects/AegisOS/docs/mobile/architecture/08_COMMUNICATION_AND_DESIGN_SYSTEM.md)
...
### 10. [State, Error, Logging & Observability](file:///C:/Users/rajaj/Projects/AegisOS/docs/mobile/architecture/09_STATE_LOGGING_OBSERVABILITY.md)
...
### 11. [Testing, Documentation, ADR & Sprint Zero Plan](file:///C:/Users/rajaj/Projects/AegisOS/docs/mobile/architecture/10_TESTING_DOCS_ADR_SPRINT0.md)
