# AegisOS Mobile — Technical Architecture Blueprint
...
### 1. [Executive Architecture](file:///d:/1_Projects/AegisOS/docs/mobile/architecture/00_EXECUTIVE_ARCHITECTURE.md)
...
### 2. [Mobile Architecture](file:///d:/1_Projects/AegisOS/docs/mobile/architecture/01_MOBILE_ARCHITECTURE.md)
...
### 3. [Layered Clean Architecture](file:///d:/1_Projects/AegisOS/docs/mobile/architecture/02_LAYERED_ARCHITECTURE.md)
...
### 4. [Feature Modules Hierarchy](file:///d:/1_Projects/AegisOS/docs/mobile/architecture/03_FEATURE_MODULES.md)
...
### 5. [Backend API Gateway Architecture](file:///d:/1_Projects/AegisOS/docs/mobile/architecture/04_BACKEND_API_ARCHITECTURE.md)
...
### 6. [Synchronization Strategy](file:///d:/1_Projects/AegisOS/docs/mobile/architecture/05_SYNCHRONIZATION.md)
...
### 7. [Local Database Design](file:///d:/1_Projects/AegisOS/docs/mobile/architecture/06_LOCAL_DATABASE.md)
...
### 8. [Security & Cryptography Architecture](file:///d:/1_Projects/AegisOS/docs/mobile/architecture/07_SECURITY_ARCHITECTURE.md)
...
### 9. [Communication & Design System Foundation](file:///d:/1_Projects/AegisOS/docs/mobile/architecture/08_COMMUNICATION_AND_DESIGN_SYSTEM.md)
...
### 10. [State, Error, Logging & Observability](file:///d:/1_Projects/AegisOS/docs/mobile/architecture/09_STATE_LOGGING_OBSERVABILITY.md)
...
### 11. [Testing, Documentation, ADR & Sprint Zero Plan](file:///d:/1_Projects/AegisOS/docs/mobile/architecture/10_TESTING_DOCS_ADR_SPRINT0.md)
