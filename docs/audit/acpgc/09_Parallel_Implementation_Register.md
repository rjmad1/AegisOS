...
**Evidence**:
- [src/platform/capability/CapabilityRegistry.ts](file:///d:/1_Projects/OpenClawOllamaLiteLLM_Transparency/src/platform/capability/CapabilityRegistry.ts) (Standalone singleton managing LLM models and token pools)
...
- [src/platform/capability/CapabilityRegistry.ts](file:///d:/1_Projects/OpenClawOllamaLiteLLM_Transparency/src/platform/capability/CapabilityRegistry.ts) (Standalone singleton, writes manifests to the file system)
...
**Evidence**:
- [src/platform/extension/ExtensionFramework.ts](file:///d:/1_Projects/OpenClawOllamaLiteLLM_Transparency/src/platform/extension/ExtensionFramework.ts) (Console/UI scoped command registry `ConsoleCommandRegistry`)
