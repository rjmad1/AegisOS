...
**Evidence**:
- [src/platform/capability/CapabilityRegistry.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/platform/capability/CapabilityRegistry.ts) (Standalone singleton managing LLM models and token pools)
- [src/platform/kernel/ResourceManager.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/platform/kernel/ResourceManager.ts) (Kernel-integrated service fulfilling `IPlatformResourceManager`)
...
**Recommendation**: Consolidate `src/platform/capability/CapabilityRegistry.ts` into `src/platform/kernel/ResourceManager.ts` to ensure the Platform Kernel maintains the sole authoritative view of system resources.
...
**Evidence**:
- [src/platform/capability/CapabilityRegistry.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/platform/capability/CapabilityRegistry.ts) (Part of the capability subsystem, manages semantic versions and dependencies)
- [src/platform/capability/CapabilityRegistry.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/platform/capability/CapabilityRegistry.ts) (Standalone singleton, writes manifests to the file system)
...
**Evidence**:
- [src/platform/extension/ExtensionFramework.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/platform/extension/ExtensionFramework.ts) (Console/UI scoped command registry `ConsoleCommandRegistry`)
- [src/platform/commands/CommandRegistry.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/platform/commands/CommandRegistry.ts) (Backend `CommandRegistryImpl`)
...
**Evidence**:
- [src/platform/console/ActionDispatcher.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/platform/console/ActionDispatcher.ts) (Line 91: `dispatch(syntheticCommandId, ...)`)
