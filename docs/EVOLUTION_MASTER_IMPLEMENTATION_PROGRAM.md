...
* **Existing Components Reused**: `PairingChallenge` model, `MobileDevice` model, [Configure.ps1](file:///C:/Users/rajaj/Projects/AegisOS/automation/Configure.ps1) script, and the base flutter `auth` feature folders.
* **Files Modified**: 
  * [automation/Configure.ps1](file:///C:/Users/rajaj/Projects/AegisOS/automation/Configure.ps1)
  * [Caddyfile](file:///C:/Users/rajaj/Projects/AegisOS/Caddyfile)
  * [docker-compose.yml](file:///C:/Users/rajaj/Projects/AegisOS/docker-compose.yml)
  * [aegis_mobile/lib/features/auth/presentation/](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/lib/features/auth/presentation/) (mock replacement)
* **Dependencies**: None.
...
* **Work Package 1.1.1**: Setup Workstation Host Tunnel and Port Binding restrictions.
  * **Engineering Task 1.1.1.1**: Restrict Ollama (`11434`) and LiteLLM (`4000`) bindings.
    ...
    * *Existing Files*: [docker-compose.yml](file:///C:/Users/rajaj/Projects/AegisOS/docker-compose.yml)
    * *New Files*: None.
    * *APIs*: None.
    * *Services*: Ollama, LiteLLM.
    * *Models/Agents/Workflows*: None.
    * *Registries*: [configs/ports.json](file:///C:/Users/rajaj/Projects/AegisOS/configs/ports.json)
    * *Tests*: None.
* **Work Package 1.1.2**: Mobile VPN Overlay Client.
  * **Engineering Task 1.1.2.1**: Implement Tailscale VPN binding on Mobile.
    ...
    * *Existing Files*: [aegis_mobile/pubspec.yaml](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/pubspec.yaml), [aegis_mobile/lib/bootstrap.dart](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/lib/bootstrap.dart)
...
* **Work Package 1.2.1**: CSR Generation & Secure Enclave Integration.
  * **Engineering Task 1.2.1.1**: Generate ECDSA keys on Mobile.
    ...
    * *Existing Files*: [aegis_mobile/pubspec.yaml](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/pubspec.yaml)
  ...
  * **Engineering Task 1.2.1.2**: Create REST APIs for CSR pairing verification.
    ...
    * *Existing Files*: [src/app/api/v2/mobile/auth/pair/route.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/app/api/v2/mobile/auth/pair/route.ts)
    * *New Files*: None.
...
* **Work Package 1.3.1**: OS Service Isolation.
  * **Engineering Task 1.3.1.1**: Modify service creation configuration to use restricted user accounts.
    ...
    * *Existing Files*: [automation/Configure.ps1](file:///C:/Users/rajaj/Projects/AegisOS/automation/Configure.ps1)
    * *New Files*: None.
...
* **Files Modified**:
  * [prisma/schema.prisma](file:///C:/Users/rajaj/Projects/AegisOS/prisma/schema.prisma)
  * [package.json](file:///C:/Users/rajaj/Projects/AegisOS/package.json)
  * [docker-compose.yml](file:///C:/Users/rajaj/Projects/AegisOS/docker-compose.yml)
  * [automation/RestoreProduction.ps1](file:///C:/Users/rajaj/Projects/AegisOS/automation/RestoreProduction.ps1)
  * [automation/BackupProduction.ps1](file:///C:/Users/rajaj/Projects/AegisOS/automation/BackupProduction.ps1)
  * [aegis_mobile/pubspec.yaml](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/pubspec.yaml)
  * [src/app/api/v2/mobile/sync/route.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/app/api/v2/mobile/sync/route.ts)
* **Dependencies**: EPIC 1.
...
* **Work Package 2.1.1**: Prisma Schema Adaptation.
  * **Engineering Task 2.1.1.1**: Switch Prisma Database Provider to PostgreSQL.
    ...
    * *Existing Files*: [prisma/schema.prisma](file:///C:/Users/rajaj/Projects/AegisOS/prisma/schema.prisma)
    * *New Files*: None.
    * *APIs*: None.
...
* **Work Package 2.1.2**: Database Recovery Scripting.
  * **Engineering Task 2.1.2.1**: Update Backup & Restore automation scripts for PostgreSQL.
    ...
    * *Existing Files*: [automation/BackupProduction.ps1](file:///C:/Users/rajaj/Projects/AegisOS/automation/BackupProduction.ps1), [automation/RestoreProduction.ps1](file:///C:/Users/rajaj/Projects/AegisOS/automation/RestoreProduction.ps1)
    * *New Files*: None.
    * *APIs/Services/Models/Agents/Workflows/Registries/Tests*: None.
...
* **Work Package 2.3.1**: Delta Synchronization Server Handler.
  * **Engineering Task 2.3.1.1**: Develop sync route to calculate changes since last timestamp.
    ...
    * *Existing Files*: [src/app/api/v2/mobile/sync/route.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/app/api/v2/mobile/sync/route.ts)
    * *New Files*: None.
...
* **Files Modified**:
  * [src/app/api/v2/mobile/telemetry/route.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/app/api/v2/mobile/telemetry/route.ts)
  * [docker-compose.yml](file:///C:/Users/rajaj/Projects/AegisOS/docker-compose.yml)
  * [src/services/infrastructure.service.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/services/infrastructure.service.ts)
* **Dependencies**: EPIC 1.
...
* **Work Package 3.1.1**: Native System Call Exporters.
  * **Engineering Task 3.1.1.1**: Connect telemetry routes to system calls (e.g., `nvidia-smi` or `systeminformation`).
    ...
    * *Existing Files*: [src/services/infrastructure.service.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/services/infrastructure.service.ts), [src/app/api/v2/mobile/telemetry/route.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/app/api/v2/mobile/telemetry/route.ts)
    * *New Files*: None.
...
* **Work Package 3.2.1**: Telemetry WebSocket Socket Server.
  * **Engineering Task 3.2.1.1**: Expose real-time websocket endpoint in API gateway.
    ...
    * *Existing Files*: [src/proxy.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/proxy.ts)
    * *New Files*: None.
...
* **Files Modified**:
  * [src/services/ai-runtime.service.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/services/ai-runtime.service.ts)
  * [src/app/api/v1/ai/runtime/route.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/app/api/v1/ai/runtime/route.ts) (or corresponding chat routes)
  * [aegis_mobile/lib/features/dashboard/presentation/](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/lib/features/dashboard/presentation/)
...
* **Work Package 4.1.1**: SSE Response Streamer.
  * **Engineering Task 4.1.1.1**: Implement backend SSE API routing for chat completions.
    ...
    * *Existing Files*: [src/services/ai-runtime.service.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/services/ai-runtime.service.ts)
...
* **Files Modified**:
  * [prisma/schema.prisma](file:///C:/Users/rajaj/Projects/AegisOS/prisma/schema.prisma)
  * [src/services/workflow.service.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/services/workflow.service.ts)
  * [aegis_mobile/lib/features/dashboard/presentation/](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/lib/features/dashboard/presentation/)
* **Dependencies**: EPIC 1, EPIC 2.
...
* **Work Package 5.1.1**: Mobile Approval Queue.
  * **Engineering Task 5.1.1.1**: Build approval card list with detail views displaying code diffs.
    ...
    * *Existing Files*: [aegis_mobile/lib/features/dashboard/presentation/](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/lib/features/dashboard/presentation/) (mock replacement)
    * *New Files*: None.
...
* **Files Modified**:
  * [src/infrastructure/events/event-bus.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/infrastructure/events/event-bus.ts)
  * [src/infrastructure/security/policy-enforcer.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/infrastructure/security/policy-enforcer.ts)
  * [src/enterprise/billing/UsageMeteringEngine.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/enterprise/billing/UsageMeteringEngine.ts)
  * [prisma/schema.prisma](file:///C:/Users/rajaj/Projects/AegisOS/prisma/schema.prisma)
...
* **Work Package 6.1.1**: Event Hub Implementation.
  * **Engineering Task 6.1.1.1**: Deploy centralized transaction logging on the event bus.
    ...
    * *Existing Files*: [src/infrastructure/events/event-bus.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/infrastructure/events/event-bus.ts)
    * *New Files*: None.
...
* **Work Package 6.2.1**: Security Filter Configurations.
  * **Engineering Task 6.2.1.1**: Set up active directory check restrictions for executing agents.
    ...
    * *Existing Files*: [src/infrastructure/security/policy-enforcer.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/infrastructure/security/policy-enforcer.ts)
    * *New Files*: None.
    * *APIs/Services/Models/Agents/Workflows/Registries/Tests*: None.
...
* **Work Package 6.3.1**: Scorecard Data Exporters.
  * **Engineering Task 6.3.1.1**: Convert Usage and Evaluation metrics to persist to Database.
    ...
    * *Existing Files*: [src/enterprise/billing/UsageMeteringEngine.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/enterprise/billing/UsageMeteringEngine.ts), [prisma/schema.prisma](file:///C:/Users/rajaj/Projects/AegisOS/prisma/schema.prisma)
    * *New Files*: None.
    * *APIs*: None.
...
|---|---|---|---|---|---|---|---|
| **TSK-SEC-01** | Backend | Scoped Service Accounts & Isolation | P0 | 8h | None | [Configure.ps1](file:///C:/Users/rajaj/Projects/AegisOS/automation/Configure.ps1) | Alpha (v0.1) |
| **TSK-SEC-02** | Gateway | Port Bindings & Local Network Hardening | P0 | 4h | None | [docker-compose.yml](file:///C:/Users/rajaj/Projects/AegisOS/docker-compose.yml), [Caddyfile](file:///C:/Users/rajaj/Projects/AegisOS/Caddyfile) | Alpha (v0.1) |
| **TSK-SEC-03** | Mobile | Secure Enclave Keypair Generator | P0 | 12h | TSK-SEC-01 | [pubspec.yaml](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/pubspec.yaml) | Alpha (v0.1) |
| **TSK-SEC-04** | Gateway | pairing CSR Handshake APIs | P0 | 8h | TSK-SEC-03 | [route.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/app/api/v2/mobile/auth/pair/route.ts) | Alpha (v0.1) |
| **TSK-DB-01** | Backend | PostgreSQL Prisma Migration | P0 | 10h | TSK-SEC-02 | [schema.prisma](file:///C:/Users/rajaj/Projects/AegisOS/prisma/schema.prisma) | Alpha (v0.2) |
| **TSK-DB-02** | Mobile | Drift Storage & SQLCipher AES Encryption | P0 | 14h | TSK-SEC-03 | [pubspec.yaml](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/pubspec.yaml) | Alpha (v0.2) |
| **TSK-DB-03** | Server/Mobile| Delta Sync Engine API & Queue | P0 | 16h | TSK-DB-01 | [sync/route.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/app/api/v2/mobile/sync/route.ts) | Alpha (v0.2) |
| **TSK-OBS-01**| Gateway | Live Hardware Telemetry Queries | P1 | 8h | TSK-SEC-01 | [telemetry/route.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/app/api/v2/mobile/telemetry/route.ts) | Beta (v0.3) |
| **TSK-OBS-02**| Gateway | 5Hz WebSocket Telemetry Streamer | P1 | 12h | TSK-OBS-01 | [proxy.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/proxy.ts) | Beta (v0.3) |
| **TSK-OBS-03**| DevOps | Jaeger Port Conflict Resolution | P1 | 4h | None | [docker-compose.yml](file:///C:/Users/rajaj/Projects/AegisOS/docker-compose.yml) | Beta (v0.3) |
| **TSK-AI-01** | Server/Mobile| SSE Chat Token Stream Integration | P1 | 16h | TSK-DB-03 | [ai-runtime.service.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/services/ai-runtime.service.ts) | Beta (v0.4) |
| **TSK-AI-02** | Mobile | chat UI Markdown & Highlighting Renderer | P1 | 12h | TSK-AI-01 | [pubspec.yaml](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/pubspec.yaml) | Beta (v0.4) |
| **TSK-AI-03** | Gateway | Ollama VRAM Model Swapper Control | P1 | 8h | TSK-AI-01 | [ai-runtime.service.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/services/ai-runtime.service.ts) | Beta (v0.4) |
| **TSK-HITL-01**| Mobile | signed Command Approval List Layout | P0 | 14h | TSK-DB-02 | [dashboard](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/lib/features/dashboard/presentation/)| RC1 (v0.5) |
| **TSK-HITL-02**| Mobile/Server| Secure Enclave Command Signatures | P0 | 16h | TSK-HITL-01 | [workflow.service.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/services/workflow.service.ts) | RC1 (v0.5) |
| **TSK-HITL-03**| Mobile/Server| E2EE Push Notifications | P1 | 18h | TSK-HITL-02 | [pubspec.yaml](file:///C:/Users/rajaj/Projects/AegisOS/aegis_mobile/pubspec.yaml) | RC1 (v0.5) |
| **TSK-ECP-01**| Gateway | Hardened Event Bus Logging | P0 | 14h | TSK-DB-01 | [event-bus.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/infrastructure/events/event-bus.ts) | GA (v1.0) |
| **TSK-ECP-02**| Gateway | Policy Enforcer Directory Interceptor | P0 | 16h | TSK-ECP-01 | [policy-enforcer.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/infrastructure/security/policy-enforcer.ts)| GA (v1.0) |
| **TSK-ECP-03**| Gateway | persistent Evaluation Scorecards | P1 | 12h | TSK-DB-01 | [UsageMeteringEngine.ts](file:///C:/Users/rajaj/Projects/AegisOS/src/enterprise/billing/UsageMeteringEngine.ts)| GA (v1.0) |
